                                ...
                                <div class="col-lg-12">
                                    <div class="border border-3 p-4 rounded">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea id="body" required class="ckeditor form-control" name="body" id="inputProductDescription" rows="3">{{ old('body',str_replace('jpeg','jpg',str_replace('../../', '../../../', $post->body))) }}</textarea>
                                            @error('body')
                                            <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
